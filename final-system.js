...
(function _v7Features() {
  ...
  function _init() {
    ...
    console.log('%c✅ V7 Features: YMLA + Gender Filter + PopCats + COD Pricing + Smart Back — ALL ACTIVE',
